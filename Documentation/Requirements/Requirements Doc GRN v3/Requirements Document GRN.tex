...
\subsection{Desktop Wireframes}

\newpage
\subsubsection{Dashboard}
\fbox{ \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{wireframe-dashboard} }

\newpage
\subsubsection{Team Page}
\fbox{ \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{wireframe-team-player-page} }

\newpage
\subsubsection{Edit Profile}
\fbox{ \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{wireframe-profile-edit} }

\newpage
\subsubsection{User Journey}
\fbox{ \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{wireframe-user-journey} }

\subsection{Mobile Wireframes}

\newpage
\subsubsection{Dashboard}
\fbox{ \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{wireframe-mobile-dashboard} }

\newpage
\subsubsection{Team Page}
\fbox{ \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{wireframe-mobile-team-player-page} }

\newpage
\subsubsection{Edit Profile}
\fbox{ \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{wireframe-mobile-profile-edit} }
