...
%TODO 
%
%Assuming the team will be working on the web app, we would also like to see wireframes for the responsive designs. Currently, the three wireframes don’t really 
%say much about the platform. Do users go directly into the dashboard or do they have to login first? If they have to login, do you have wireframes to show this? So it would be really good to describe these wireframes and also include a user journey as discussed in the previous meeting.
%Can we also do something about these pages so they don’t break into a new page when not needed.
