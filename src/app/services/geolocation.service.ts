...
export class GeolocationService {
   ...
   *   - enableHighAccuracy: Specify true to obtain the most accurate position possible, or false to optimize in
   *    favor of performance and power consumption.
   ...
   *                 If maximumAge is zero (0), watchPosition always tries to obtain an updated position, even if a
   *                 cached position is already available.
